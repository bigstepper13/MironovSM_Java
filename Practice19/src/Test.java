...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        //tests for ex 2 хранить типы данных:
        ...
        // tests for ex 3 возвоащает любой элемент массива по индексу
        System.out.println("Ex3: ");
        System.out.println(get(a, 0));
        System.out.println(get(a, 2));
        System.out.println();

        // tests for ex 4 содержимое каталога и первые 5
        ...
        //tests for ex 5 создание коллекции и помещение туда переданных объектов
